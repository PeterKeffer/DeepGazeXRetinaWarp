...
class FovealTransform(torch.nn.Module):
    def __init__(self, fovea_size, img_target_size, img_size, jitter_type, jitter_amount, device, retina_size=90):
        super().__init__()
        self.device=device
...
for img_id in train_img_ids:
    print("Processing training image:", img_id)
...
for img_id in val_img_ids:
    print("Processing validation image:", img_id)
